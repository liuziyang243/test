package com.crscd.passengerservice.display.guiderule.dto;
...
public class ScreenGuideRuleDTO {
    ...
    public String toString() {
        return "ScreenGuideRuleDTO{" +
                "trainType=" + trainType +
                ", stationType=" + stationType +
                ", id=" + id +
                ", stationName='" + stationName + '\'' +
                ", screenType=" + screenType +
                ", upTimeReference=" + upTimeReference +
                ", upTimeOffset=" + upTimeOffset +
                ", downTimeReference=" + downTimeReference +
                ", downTimeOffset=" + downTimeOffset +
                '}';
    }
}
